...
def screen_score(n_overlaping_features, sum_overlaping_features_intensities, pearson_score):
    ...
    if n_overlaping_features >= 3 and sum_overlaping_features_intensities >= 0.9 and pearson_score >= 0.8:
        return "A"
    elif n_overlaping_features == 2 and sum_overlaping_features_intensities >= 0.9 and pearson_score >= 0.8:
        return "B"
    elif n_overlaping_features >= 2 and sum_overlaping_features_intensities >= 0.5 and pearson_score >= 0.6:
        return "C"
